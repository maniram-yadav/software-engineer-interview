 ...
 *   Output: true
 */
public class P88_ValidateBinarySearchTree {
    ...
    public static void main(String[] args) {
        P88_ValidateBinarySearchTree sol = new P88_ValidateBinarySearchTree();
        test(sol, build(2, 1, 3), true);
        test(sol, build(5, 1, 4, null, null, 3, 6), false);
        test(sol, build(1), true);
        System.out.println("All tests passed.");
    }

    private static void test(P88_ValidateBinarySearchTree sol, TreeNode root, boolean expected) {
