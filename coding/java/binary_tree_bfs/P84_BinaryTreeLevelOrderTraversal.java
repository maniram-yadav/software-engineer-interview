 ...
 *   Output: [[3],[9,20],[15,7]]
 */
public class P84_BinaryTreeLevelOrderTraversal {
    ...
    public static void main(String[] args) {
        P84_BinaryTreeLevelOrderTraversal sol = new P84_BinaryTreeLevelOrderTraversal();
        test(sol, build(3, 9, 20, null, null, 15, 7), "[[3], [9, 20], [15, 7]]");
        test(sol, build(1), "[[1]]");
        test(sol, null, "[]");
        System.out.println("All tests passed.");
    }

    private static void test(P84_BinaryTreeLevelOrderTraversal sol, TreeNode root, String expected) {
        java.util.List<java.util.List<Integer>> actual = sol.levelOrder(root);
