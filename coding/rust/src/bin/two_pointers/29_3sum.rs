...
//! [nums[i], nums[j], nums[k]] that sum to 0. Solved by sorting, then for
//! each fixed first element, two-pointer scanning the rest, skipping
//! duplicates.
//!
//! Example:
